...
public static Doctor general2 = new Doctor("Dr. Addison Montgomery",5,"Niederurselerstr. 10");
public static Doctor general3 = new Doctor("Dr. Mark Sloan",10,"Ginnheimerstr. 10");
...
public static Doctor lungs1 = new Doctor("Dr. April Kepner",2,"Harheimersr. 10");
public static Doctor lungs2 = new Doctor("Dr. Jackson Avery",10,"Praunheimerstr. 10");
